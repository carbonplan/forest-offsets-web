...
const Index = ({ fireMetadata, fireProjects }) => {
  ...
  const tiles = {
    projects: `https://carbonplan-forest-offsets.s3.us-west-1.amazonaws.com/web/archive/2021/tiles/projects/{z}/{x}/{y}.pbf`,
    fires: `https://carbonplan-forest-offsets.s3.us-west-1.amazonaws.com/web/archive/2021/tiles/fires/{z}/{x}/{y}.pbf`,
  }
...
export async function getServerSideProps() {
  const prefix =
    'https://carbonplan-forest-offsets.s3.us-west-1.amazonaws.com/web/archive/2021'
  try {
